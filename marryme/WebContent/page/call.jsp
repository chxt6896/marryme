...
{
//	RequestToken resToken=weboauth.request("http://do.jhost.cn/marrymewmf/page/callback.jsp");
	RequestToken resToken=weboauth.request("http://localhost:8080/marryme/page/callback.jsp");
	if(resToken!=null){
